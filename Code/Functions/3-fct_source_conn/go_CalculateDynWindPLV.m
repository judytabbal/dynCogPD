...
% Inputs:
%   dataEpochs    : cell of length number of trials, each is 2D matrix of dim:[nROIs,nb_samples]
...
%   overLapWindow : length of overlapping in sec (ex 0.9*totalWindow)
%   step          : total-overlap (in sec)
%   n_wind        : number of temporal windows
%
% Output:
